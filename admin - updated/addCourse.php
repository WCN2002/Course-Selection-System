...
if ( isset($_POST['courseID']) && isset($_POST['courseName'])
     ...
     && isset($_POST['outline'])) {
    $sql = "INSERT INTO courses (courseID, courseName, location, department, professor, maxCapacity, day, time, outline, remainSeat)
              VALUES (:courseID, :courseName, :location, :department, :professor, :maxCapacity, :day, :time, :outline, :maxCapacity)";
